...
Nuestro proyecto está enfocado en la predicción de resultados de partidos de fútbol entre equipos de las mejores ligas o divisiones de países europeos, siendo posibles resultados una victoria del equipo local, una derrota o un empate. Para esto buscamos construir un modelo basado en estadísticas de los equipos, resultados históricos y las cuotas o multiplicadores que ofrecen las casas de apuestas.

### Descripción de los datos
Una gran cantidad de los datos usados provienen de http://www.football-data.co.uk, un sitio que tiene archivos en csv por cada año y cada liga o división de varios países europeos. Dentro de los csv cada fila corresponde a un partido y cada columna a un atributo del partido, donde la mayoría son datos de casas de apuestas. ****INSERTAR DATOS PARA DESCARGAR Y EXPLICAR LOS OTROS DATOS****
...
****INSERTAR DATOS LIMPIOS PARA DESCARGAR Y EXPLICAR ALGUNA OTRA LIMPIEZA****
